        ...
        VStack {
            Button(
                action: {
                    ...
                    let a = voiceRecorderViewModel.getFileInfo(for: recordedFile)
                    print(a)
                },
                label: {
                    VStack {
                        ...
                        HStack {
                            if let creationDate = creationDate {
                                Text(creationDate.fVoiceRecorderTime)
                                    .font(.system(size: 14))
            ...
            if voiceRecorderViewModel.selectedRecoredFile == recordedFile {
                VStack {
                    ...
                    HStack {
                        Text(voiceRecorderViewModel.playedTime.fTimeInterval)
